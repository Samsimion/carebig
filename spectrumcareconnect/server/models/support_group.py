...
class SupportGroup(db.Model, SerializerMixin):
    ...
    group_bans = db.relationship('GroupBan',back_populates='support_group', foreign_keys='GroupBan.support_group_id', cascade='all, delete-orphan')
    ...
    group_role = db.relationship('GroupRole', back_populates='support_group', foreign_keys='GroupRole.support_group_id', cascade='all, delete-orphan' )

    serialize_rules =('-group_members.support_groups','-group_posts.support_groups', '-group_events.support_groups', '-group_report.support_group','-group_bans.support_group', '-group_setting.support_group', '-group_role.support_group',)
